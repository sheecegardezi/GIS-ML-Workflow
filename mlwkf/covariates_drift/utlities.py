...
@ray.remote
def create_line_geotiff(y_index, x_array, covariates, path_to_trained_model, line_geotiff_folder, model):
...
def create_predicted_geotiff(area_of_interest, covariates, path_to_trained_model, line_geotiff_folder, merged_geotiff_folder, output_folder, model, cpus_per_job, gpu_per_job):
